...
int main(int argc, char *argv[]) {
  ...
  if (strcmp(argv[1], "1") == 0){
    printf("You are using Dynamo ONNX for inference in C++ with CUDA!\n");
    ...
    printf("You are using Torchscript ONNX for inference in C++ with CUDA!\n");
    ...
    printf("You are doing inference with 20 epochs resuming trained ONNX for conversation inference with C++ with CUDA!\n");
    ...
    printf("You are doing inference with 40 epochs resuming trained ONNX for conversation inference with C++ with CUDA!\n");
    model_path = (ORTCHAR_T *)ONNX_C40RESUMING_INFERENCE_PATH;
    input_names[0] = ONDEVICE_INFERENCE_INPUT;
    output_names[0] = ONDEVICE_INFERENCE_OUTPUT;
  }else if(strcmp(argv[1], "5") == 0) {
    printf("You are doing inference with 20 epochs ondevice trained ONNX for conversation inference with C++ with CUDA!\n");
    model_path = (ORTCHAR_T *)ONNX_C20ONDEVICE_INFERENCE_PATH;
    input_names[0] = ONDEVICE_INFERENCE_INPUT;
    output_names[0] = ONDEVICE_INFERENCE_OUTPUT;
  }else if(strcmp(argv[1], "6") == 0) {
    printf("You are doing inference with 40 epochs ondevice trained ONNX for conversation inference with C++ with CUDA!\n");
    model_path = (ORTCHAR_T *)ONNX_C40ONDEVICE_INFERENCE_PATH;
    input_names[0] = ONDEVICE_INFERENCE_INPUT;
    output_names[0] = ONDEVICE_INFERENCE_OUTPUT;
  }else if(strcmp(argv[1], "7") == 0) {
    printf("You are doing inference with 20 epochs resuming trained ONNX for question inference with C++ with CUDA!\n");
    model_path = (ORTCHAR_T *)ONNX_Q20RESUMING_INFERENCE_PATH;
    input_names[0] = ONDEVICE_INFERENCE_INPUT;
    output_names[0] = ONDEVICE_INFERENCE_OUTPUT;
  }else if(strcmp(argv[1], "8") == 0) {
    printf("You are doing inference with 40 epochs resuming trained ONNX for question inference with C++ with CUDA!\n");
    model_path = (ORTCHAR_T *)ONNX_Q40RESUMING_INFERENCE_PATH;
    input_names[0] = ONDEVICE_INFERENCE_INPUT;
    output_names[0] = ONDEVICE_INFERENCE_OUTPUT;
  }else if(strcmp(argv[1], "9") == 0) {
    printf("You are doing inference with 20 epochs ondevice trained ONNX for question inference with C++ with CUDA!\n");
    model_path = (ORTCHAR_T *)ONNX_Q20ONDEVICE_INFERENCE_PATH;
    input_names[0] = ONDEVICE_INFERENCE_INPUT;
    output_names[0] = ONDEVICE_INFERENCE_OUTPUT;
  }else if(strcmp(argv[1], "10") == 0) {
    printf("You are doing inference with 40 epochs ondevice trained ONNX for question inference with C++ with CUDA!\n");
  ...
  const OrtCUDAProviderOptions cudaprovideroption;
  session_option.AppendExecutionProvider_CUDA(cudaprovideroption);
